...
extension appbskytypes {
    public struct UnspeccedSearchPostsSkeleton_Output: Codable, Sendable {
        ...
        public init(from decoder: any Decoder) throws {
            ...
            self.posts = try keyedContainer.decode([UnspeccedDefs_SkeletonSearchPost].self, forKey: .posts)
    ...
    public indirect enum UnspeccedSearchPostsSkeleton_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func UnspeccedSearchPostsSkeleton(author: String? = nil, cursor: String? = nil, domain: String? = nil, lang: String? = nil, limit: Int? = nil, mentions: String? = nil, q: String, since: String? = nil, sort: appbskytypes.UnspeccedSearchPostsSkeleton_Sort? = nil, tag: [String]? = nil, until: String? = nil, url: String? = nil, viewer: String? = nil) async throws -> appbskytypes.UnspeccedSearchPostsSkeleton_Output {
        ...
        do {
            return try await fetch(endpoint: "app.bsky.unspecced.searchPostsSkeleton", contentType: "*/*", httpMethod: .get, params: params, input: Bool?.none, retry: true)
        } catch let error as UnExpectedError {
            throw appbskytypes.UnspeccedSearchPostsSkeleton_Error(error: error)
        }
    }
}
