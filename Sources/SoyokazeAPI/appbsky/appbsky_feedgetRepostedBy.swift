...
extension appbskytypes {
    public struct FeedGetRepostedBy_Output: Codable, Sendable {
        ...
        public init(from decoder: any Decoder) throws {
            ...
            self.repostedBy = try keyedContainer.decode([ActorDefs_ProfileView].self, forKey: .repostedBy)
    ...
    public indirect enum FeedGetRepostedBy_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func FeedGetRepostedBy(cid: String? = nil, cursor: String? = nil, limit: Int? = nil, uri: String) async throws -> appbskytypes.FeedGetRepostedBy_Output {
        let params: Parameters = ["cid": .string(cid), "cursor": .string(cursor), "limit": .integer(limit), "uri": .string(uri)]
        do {
            return try await fetch(endpoint: "app.bsky.feed.getRepostedBy", contentType: "*/*", httpMethod: .get, params: params, input: Bool?.none, retry: true)
        } catch let error as UnExpectedError {
            throw appbskytypes.FeedGetRepostedBy_Error(error: error)
        }
    }
}
