...
extension appbskytypes {
    public indirect enum FeedPost_Embed: Codable, Sendable {
    ...
    public struct FeedPost_Entity: Codable, Sendable {
    ...
    public indirect enum FeedPost_Labels: Codable, Sendable {
