...
extension appbskytypes {
    ...
    public indirect enum BookmarkDeleteBookmark_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func BookmarkDeleteBookmark(input: appbskytypes.BookmarkDeleteBookmark_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "app.bsky.bookmark.deleteBookmark", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw appbskytypes.BookmarkDeleteBookmark_Error(error: error)
        }
    }
}
