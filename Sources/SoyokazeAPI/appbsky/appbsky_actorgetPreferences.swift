...
extension appbskytypes {
    ...
    public indirect enum ActorGetPreferences_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func ActorGetPreferences() async throws -> appbskytypes.ActorGetPreferences_Output {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "app.bsky.actor.getPreferences", contentType: "*/*", httpMethod: .get, params: params, input: Bool?.none, retry: true)
        } catch let error as UnExpectedError {
            throw appbskytypes.ActorGetPreferences_Error(error: error)
        }
    }
}
