...
extension appbskytypes {
    ...
    public indirect enum GraphUnmuteActorList_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func GraphUnmuteActorList(input: appbskytypes.GraphUnmuteActorList_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "app.bsky.graph.unmuteActorList", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw appbskytypes.GraphUnmuteActorList_Error(error: error)
        }
    }
}
