...
extension comatprototypes {
    ...
    public struct RepoPutRecord_Output: Codable, Sendable {
    ...
    public indirect enum RepoPutRecord_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func RepoPutRecord(input: comatprototypes.RepoPutRecord_Input) async throws -> comatprototypes.RepoPutRecord_Output {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.repo.putRecord", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.RepoPutRecord_Error(error: error)
        }
    }
}
