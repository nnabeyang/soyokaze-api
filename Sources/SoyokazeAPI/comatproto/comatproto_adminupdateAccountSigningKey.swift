...
extension comatprototypes {
    ...
    public indirect enum AdminUpdateAccountSigningKey_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func AdminUpdateAccountSigningKey(input: comatprototypes.AdminUpdateAccountSigningKey_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.admin.updateAccountSigningKey", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.AdminUpdateAccountSigningKey_Error(error: error)
        }
    }
}
