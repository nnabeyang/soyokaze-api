...
extension comatprototypes {
    public struct ServerCreateAccount_Input: Codable, Sendable {
    ...
    public indirect enum ServerCreateAccount_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func ServerCreateAccount(input: comatprototypes.ServerCreateAccount_Input) async throws -> comatprototypes.ServerCreateAccount_Output {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.server.createAccount", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.ServerCreateAccount_Error(error: error)
        }
    }
}
