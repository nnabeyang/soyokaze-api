...
extension comatprototypes {
    public struct AdminDeleteAccount_Input: Codable, Sendable {
    ...
    public indirect enum AdminDeleteAccount_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func AdminDeleteAccount(input: comatprototypes.AdminDeleteAccount_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.admin.deleteAccount", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.AdminDeleteAccount_Error(error: error)
        }
    }
}
