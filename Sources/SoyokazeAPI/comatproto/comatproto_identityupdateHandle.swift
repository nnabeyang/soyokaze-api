...
extension comatprototypes {
    ...
    public indirect enum IdentityUpdateHandle_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func IdentityUpdateHandle(input: comatprototypes.IdentityUpdateHandle_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.identity.updateHandle", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.IdentityUpdateHandle_Error(error: error)
        }
    }
}
