...
extension comatprototypes {
    public struct ServerDeleteAccount_Input: Codable, Sendable {
    ...
    public indirect enum ServerDeleteAccount_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func ServerDeleteAccount(input: comatprototypes.ServerDeleteAccount_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.server.deleteAccount", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.ServerDeleteAccount_Error(error: error)
        }
    }
}
