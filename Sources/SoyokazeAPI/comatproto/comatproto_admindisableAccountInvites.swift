...
extension comatprototypes {
    public struct AdminDisableAccountInvites_Input: Codable, Sendable {
    ...
    public indirect enum AdminDisableAccountInvites_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func AdminDisableAccountInvites(input: comatprototypes.AdminDisableAccountInvites_Input) async throws -> Bool {
        let params: Bool? = nil
        do {
            return try await fetch(endpoint: "com.atproto.admin.disableAccountInvites", contentType: "application/json", httpMethod: .post, params: params, input: input, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.AdminDisableAccountInvites_Error(error: error)
        }
    }
}
