...
extension comatprototypes {
    public indirect enum SyncGetBlocks_Error: XRPCError {
...
extension XRPCClientProtocol {
    public mutating func SyncGetBlocks(cids: [String], did: String) async throws -> Data {
        let params: Parameters = ["cids": .array(cids), "did": .string(did)]
        do {
            return try await fetch(endpoint: "com.atproto.sync.getBlocks", contentType: "*/*", httpMethod: .get, params: params, input: Bool?.none, retry: true)
        } catch let error as UnExpectedError {
            throw comatprototypes.SyncGetBlocks_Error(error: error)
        }
    }
}
